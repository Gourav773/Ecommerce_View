    ...
    <div className="mx-auto max-w-md fade-in">
      <div className="surface-card p-6">
        ...
        <div className="mt-4 flex justify-between text-sm">
          <Link href="/forgot-password" className="text-[var(--color-secondary)] hover:underline">Forgot password?</Link>
          <Link href="/register" className="text-[var(--color-secondary)] hover:underline">Create account</Link>
        </div>
      </div>
    </div>
  );
